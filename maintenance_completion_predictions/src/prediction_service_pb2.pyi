...
class PredictResponse(_message.Message):
    ...
    def __init__(self, prediction_results: _Optional[_Iterable[float]] = ...) -> None: ...

class TaskInfo(_message.Message):
    __slots__ = ["due_date", "estimated_hours", "completed_on", "current_labor_hours", "category_name", "site_name", "created_at", "is_completed_on_time"]
    ...
    def __init__(self, due_date: _Optional[str] = ..., estimated_hours: _Optional[float] = ..., completed_on: _Optional[str] = ..., current_labor_hours: _Optional[float] = ..., category_name: _Optional[str] = ..., site_name: _Optional[str] = ..., created_at: _Optional[str] = ..., is_completed_on_time: bool = ...) -> None: ...
